    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_minus:
                ...
                if(selected_count<=1)
                    Toast.makeText(this, "최소주문 1개다", Toast.LENGTH_SHORT).show();
                else{
                    --selected_count;
            ...
            case R.id.btn_plus:
                selected_count = Integer.parseInt(edit_count.getText().toString());
                if(selected_count>=5)
                    Toast.makeText(this, "최대주문 5개다", Toast.LENGTH_SHORT).show();
                else{
                    ++selected_count;
                    edit_count.setText(selected_count+"");
                    //edit_count.setText(Integer.toString(selected_count));
            ...
            case R.id.btn_pay:
                if(chk_agree.isChecked()){
                    ...
                    intent.putExtra("MSG","30404김민형");
                    intent.putExtra("PRICE",val_pay);
                    startActivity(intent);
                }else{
                    Toast.makeText(this,"동의하세요!",Toast.LENGTH_SHORT);
                }
                break;
